...
@vera_agent("Pickleball Official Docs Agent")
def run(state: GraphState) -> dict:
    print(f"[Pickleball Official Docs Agent] Processing...")
    """
    ...
    print(f"[Pickleball Official Docs Agent] {len(result.documents)} docs → {len(facts)} structured facts")
