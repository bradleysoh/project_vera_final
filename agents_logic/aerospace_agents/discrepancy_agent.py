"""
================================================================================
Aerospace Discrepancy Agent — Deterministic Logic Gate (Zero LLM Calls)
================================================================================
...
def _resolve_conflicts(
    ...
    if authoritative["priority"] == 2:  # official is top
        ...
        if newer_informal:
            ...
            print(f"[Aerospace Discrepancy Agent] Informal override for '{attribute}' — "
...
@vera_agent("Aerospace Discrepancy Agent")
def run(state: GraphState) -> dict:
    ...
    print(f"[Aerospace Discrepancy Agent] Facts: "
    ...
    print(f"[Aerospace Discrepancy Agent] Verdict: {overall.value} "
